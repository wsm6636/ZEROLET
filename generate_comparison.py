...
def sort_csv_by_policy(csv_file, suffix=''):
    ...
    is_rtss = (suffix == '') or (suffix == '_RTSS') or (suffix == '_ADD') or (suffix == '_PAORDER')
...
def process_csv_file_runtime(input_file, output_file=None):
    """
...
def generate_final_comparison(common_csv_a, common_csv_b, suffix=''):
    ...
    eg.
    For add: common_csv_a = add, common_csv_b = active
...
def main():
    ...
    parser.add_argument('--common_csv_active_add', type=str, default='common_results_active_add.csv',
                        help='--suffix _ADD: active_new result csv file (common_results_active_add.csv)')
    parser.add_argument('--common_csv_passive_order', type=str, default='common_results_passive_order.csv',
                        help='--suffix _PAORDER: passive_order result csv file (common_results_passive_order.csv)')
    ...
    if args.suffix == '_ADD':
        ...
        csv_b = args.common_csv_active_add
        print(f"Using ADD mode: comparing {csv_a} vs {csv_b}")
    elif args.suffix == '_PAORDER':
        csv_a = args.common_csv_passive
        csv_b = args.common_csv_passive_order
        print(f"Using PAORDER mode: comparing {csv_a} vs {csv_b}")
    else:
        csv_a = args.common_csv_passive
